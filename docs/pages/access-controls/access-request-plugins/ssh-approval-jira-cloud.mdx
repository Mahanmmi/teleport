...
Use the following command to create the Kubernetes secret referenced above from the identity file you generated earlier:
...
<Tabs>
<TabItem label="Cloud" scopes={["oss", "enterprise", "cloud"]}>
```code
$ teleport-jira start
```
</TabItem>
