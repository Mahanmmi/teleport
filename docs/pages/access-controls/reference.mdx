...
| `ssh_file_copying` | Allow SCP/SFTP | Logical "AND" i.e. if all roles allows file copying, it's allowed |
...
[shared sessions](../use-teleport/tsh.mdx#sharing-sessions) and
